...
<script type="text/javascript">
	function cancel()
	{
	window.location = "<?echo $this->uri->segment(2)=='department' ? base_url() : base_url('master/department');?>";
	}
</script>
						...
						<?php echo form_open($faction, array('id'=>'myform','class'=>'form-horizontal','enctype'=>'multipart/form-data'));?>
							...
							<div class="widget">
								<div class="widget-header">
									<h3><i class="fa  fa-flag"></i> Department Form</h3></div>
								<div class="widget-content">
									<div class="form-horizontal">
										<div class="form-group">
											<label class="col-md-2 control-label">Department ID</label>
											<div class="col-md-3">
												<input type="text" class="form-control" name="id_department" value="<?php echo $dt['id_department'];?>" placeholder="" autocomplete="off">
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" class="form-control" name="department_name" value="<?php echo $dt['department_name'];?>" placeholder="" autocomplete="off">
											</div>
