      ...
      <div class="modal-content">
        <div class="modal-header">
         ...
         <!-- <h4 class="modal-title">ALERT</h4> -->
          ...
          <?php echo form_open(base_url('master/outlet_delete'), array('id'=>'myform','class'=>'form-horizontal'));?>
				...
				<div class="main-content">
					...
					<div class="widget widget-table">
						<div class="widget-header">
							<h3>							
								<a href="<? echo base_url()?>master/outlet_add"><button type="button" class="btn btn-default btn-xs"><i class="fa  fa-car"></i>	Add Dealer</button></a>
							</h3> 
...
foreach ($array_data as $row)
   ...
   ?>
									<tr>
										...
										<td><?=$row->contact;?></td>			
										<td>
											<a href="<?php echo base_url()?>master/outlet_add/<?=base64_encode(($row->id))?>"><span class="label label-success">EDIT</span></a>
