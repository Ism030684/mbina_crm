      ...
      <div class="modal-content">
        <div class="modal-header">
         ...
         <!-- <h4 class="modal-title">ALERT</h4> -->
          ...
          <?php echo form_open(base_url('master/department_delete'), array('id'=>'myform','class'=>'form-horizontal'));?>
				...
				<div class="main-content">
					...
					<div class="widget widget-table">
						<div class="widget-header">
							<h3>							
								<a href="<? echo base_url()?>master/department_add"><button type="button" class="btn btn-default btn-xs"><i class="fa  fa-flag"></i>	Add Department</button></a>
							</h3> 
