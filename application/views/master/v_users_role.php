      ...
      <div class="modal-content">
        <div class="modal-header">
         ...
         <!-- <h4 class="modal-title">ALERT</h4> -->
          ...
          <?php echo form_open(base_url('master/users_role_delete'), array('id'=>'myform','class'=>'form-horizontal'));?>
				...
				<div class="main-content">
					...
					<div class="widget widget-table">
						<div class="widget-header">
							<h3>							
								<a href="<? echo base_url()?>master/users_role_add"><button type="button" class="btn btn-default btn-xs"><i class="fa fa-check-square-o"></i>	Add  Position</button></a>
							</h3> 
...
foreach ($array_data as $row)
   ...
   ?>
									<tr>
										<td><?=$i?></td>
										<td><?=$row->id_users_role;?></td>
										<td><?=$row->users_role;?></td>
										<td>
											<a href="<?php echo base_url()?>master/users_role_add/<?=base64_encode(($row->id))?>"><span class="label label-success">EDIT</span></a>
