			...
			<div class="row">
				<div class="col-lg-4 ">
					<ul class="breadcrumb">
						...
						<li class="active">Users Dealer</li>
					</ul>
				</div>
				...
				<div class="main-content">
					...
					<div class="widget widget-table">
						<div class="widget-header">
							<h3>							
								<a href="<? echo base_url()?>master/users_add"><button type="button" class="btn btn-default btn-xs"><i class="fa fa-group"></i>	Add New Users</button></a>
							</h3> 
...
foreach ($array_users as $row)
   ...
   ?>
									<tr>
										...
										<td>
											<a href="<?php echo base_url()?>master/users_add/<?=base64_encode(($row->id))?>" ><span class="label label-success">EDIT</span></a>
