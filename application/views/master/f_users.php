								...
								<div class="widget-content">
									<div class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<select class="form-control" name="outlet_dealer_id" id="outlet_dealer_id">
												<?php 
												foreach ($cmb_outlet as $row)
												{
												?>
													<option value="<?php echo $row->outlet_id;?>" class="<?php echo $row->group_dealer_id;?>" <?php if($dt['outlet_dealer_id']==$row->outlet_id) echo 'selected';?> ><?php echo  $row->outlet;?></option>
												<?php 
												}
												?>
												</select>
