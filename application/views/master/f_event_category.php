...
<script type="text/javascript">
	function cancel()
	{
	window.location = "<?echo $this->uri->segment(2)=='department' ? base_url() : base_url('master/event_category');?>";
	}
</script>
						...
						<?php echo form_open($faction, array('id'=>'myform','class'=>'form-horizontal','enctype'=>'multipart/form-data'));?>
							...
							<div class="widget">
								<div class="widget-header">
									<h3><i class="fa  fa-flag"></i> Event category Form</h3></div>
								<div class="widget-content">
									<div class="form-horizontal">
										<div class="form-group">
											<label class="col-md-2 control-label">Event Category ID</label>
											<div class="col-md-3">
												<input type="text" class="form-control" name="event_category_id" value="<?php echo $dt['event_category_id'];?>" placeholder="" autocomplete="off">
											</div>
												
										</div>
										<div class="form-group">
											<label class="col-md-2 control-label">Event Category Name</label>
											<div class="col-md-3">
												<input type="text" class="form-control" name="event_category_name" value="<?php echo $dt['event_category_name'];?>" placeholder="" autocomplete="off">
											</div>
