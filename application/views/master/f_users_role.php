...
<script type="text/javascript">
	function cancel()
	{
	window.location = "<?echo $this->uri->segment(2)=='department' ? base_url() : base_url('master/users_role');?>";
	}
</script>
						...
						<?php echo form_open($faction, array('id'=>'myform','class'=>'form-horizontal','enctype'=>'multipart/form-data'));?>
							...
							<div class="widget">
								<div class="widget-header">
									<h3><i class="fa fa-check-square-o"></i> Position Form</h3></div>
								<div class="widget-content">
									<div class="form-horizontal">
										<div class="form-group">
											<label class="col-md-2 control-label">Position ID</label>
											<div class="col-md-3">
												<input type="text" class="form-control" name="id_users_role" value="<?php echo $dt['id_users_role'];?>" placeholder="" autocomplete="off">
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" class="form-control" name="users_role" value="<?php echo $dt['users_role'];?>" placeholder="" autocomplete="off">
											</div>
