...
<script type="text/javascript">
	function cancel()
	{
	window.location = "<?echo $this->uri->segment(2)=='outlet' ? base_url() : base_url('master/outlet');?>";
	}
</script>
						...
						<?php echo form_open($faction, array('id'=>'myform','class'=>'form-horizontal','enctype'=>'multipart/form-data'));?>
							...
							<div class="widget">
								<div class="widget-header">
									<h3><i class="fa  fa-car"></i>Dealer Form</h3></div>
								<div class="widget-content">
									<div class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" class="form-control" name="outlet_id" value="<?php echo $dt['outlet_id'];?>" placeholder="" autocomplete="off">
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" class="form-control" name="outlet" value="<?php echo $dt['outlet'];?>" placeholder="" autocomplete="off">
											</div>
										...
										<div class="form-group">
											<label class="col-md-2 control-label">Sign Prepared By</label>
											<div class="col-md-3">
												<input type="text" class="form-control" name="sign_prepared_by" value="<?php echo $dt['sign_prepared_by'];?>" placeholder="" autocomplete="off">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-2 control-label">Sign Acknowledged by </label>
											<div class="col-md-3">
