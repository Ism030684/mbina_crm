      ...
      <div class="modal-content">
        <div class="modal-header">
         ...
         <!-- <h4 class="modal-title">ALERT</h4> -->
                ...
                <?php echo form_open(base_url('master/users_delete'), array('id'=>'myform','class'=>'form-horizontal'));?>
			...
			<div class="row">
				<div class="col-lg-4 ">
					<ul class="breadcrumb">
						...
						<li class="active">Users Mbina</li>
					</ul>
				</div>
				...
				<div class="main-content">
					...
					<div class="widget widget-table">
						<div class="widget-header">
							<h3>							
								<a href="<? echo base_url()?>master/users_mbina_add"><button type="button" class="btn btn-default btn-xs"><i class="fa fa-group"></i>	Add New Users Mbina</button></a>
							</h3> 
...
foreach ($array_users as $row)
   ...
   ?>
									<tr>
										...
										<td>
											<a href="<?php echo base_url()?>master/users_mbina_add/<?=base64_encode(($row->id))?>" ><span class="label label-success">EDIT</span></a>
